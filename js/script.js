...
function addTask(e){
  ...
  $.ajax({
    url:"https://api.mlab.com/api/1/databases/task_manager/collections/tasks?apiKey=" + apiKey,
    data: JSON.stringify({
      "task_name": task_name,
      "category": category,
      "due_date": due_date,
...
function getTask(id){
  $.get('https://api.mlab.com/api/1/databases/task_manager/collections/tasks/'+id+'?apiKey=' + apiKey, function (task){
...
function editTask(e){
  ...
  var is_urgent = $('#is_urgent').val();
  $.ajax({
    url:'https://api.mlab.com/api/1/databases/task_manager/collections/tasks/'+task_id+'?apiKey=' + apiKey,
    data: JSON.stringify({
      "task_name": task_name,
      "category": category,
      "due_date": due_date,
...
function getCategoryOptions(){
  $.get("https://api.mlab.com/api/1/databases/task_manager/collections/categories?apiKey=" + apiKey, function(data){
    var output;
...
function addCategory(e){
  ...
  $.ajax({
    url:"https://api.mlab.com/api/1/databases/task_manager/collections/categories?apiKey=" + apiKey,
    data: JSON.stringify({
...
function getCategory(id){
  $.get('https://api.mlab.com/api/1/databases/task_manager/collections/categories/'+id+'?apiKey=' + apiKey, function (category){
...
function editCategory(e){
  ...
  var category_name = $('#category_name').val();
  $.ajax({
    url:'https://api.mlab.com/api/1/databases/task_manager/collections/categories/'+category_id+'?apiKey=' + apiKey,
    data: JSON.stringify({
      "category_name": category_name
    }),
    type:'PUT',
